<template>
  <GlassCard no-padding class="h-full flex flex-col relative">
    ...
    <div ref="messagesContainer" class="messages-container flex-1 overflow-y-auto p-5 space-y-6 scroll-smooth" @scroll="handleScroll">
      <!-- Welcome message -->
      ...
      <div v-if="aiStatus === 'thinking' && aiThinkingText" class="flex gap-3">
        <div class="w-8 h-8 rounded-full flex items-center justify-center border text-xs bg-cyan-400/20 border-cyan-400/30">
          AI
        </div>
        <div class="flex flex-col gap-1 max-w-[85%]">
          <div class="border rounded-2xl p-3 text-sm text-gray-200 leading-relaxed shadow-sm bg-white/5 border-white/10 rounded-tl-none">
            <div class="flex items-center gap-2">
