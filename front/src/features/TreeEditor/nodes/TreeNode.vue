  ...
  >
    ...
    <div class="flex justify-between items-start mb-2">
      <div class="flex flex-col">
        ...
        <span class="text-xs font-medium text-gray-400 tracking-wide uppercase">{{ data.type || 'TREE' }} NODE</span>
    ...
    <div class="mt-4 mb-3">
      <div class="text-4xl font-bold tracking-tight text-white flex items-baseline gap-1">
        {{ data.progress || 0 }}<span class="text-xl text-gray-500 font-normal">%</span>
      </div>
    </div>
    ...
    <div class="relative h-3 w-full bg-white/10 rounded-full overflow-hidden mb-4">
      ...
      <div 
        ...
        :style="{ width: (data.progress || 0) + '%', opacity: 0.3 }"
      ></div>
    </div>
