...
from new.capabilities import CapabilityBase  # 假设 CapabilityBase 在此路径
from new.capabilities.llm_memory.manager import UnifiedMemoryManager,SHARED_MEM0_CLIENT
from new.capabilities.llm_memory.memory_interfaces import (
    IVaultRepository,
