...
# 导入测试所需的模块
from new.external.database.redis_adapter import redis_adapter
from new.common.utils.actor_reference_manager import actor_reference_manager
from new.agents.router_actor import RouterActor
from new.agents.agent_registry import agent_registry
...
class TestModuleIntegration(unittest.TestCase):
    ...
    def test_redis_adapter_initialization(self, mock_config_manager, mock_redis_module):
        ...
        from new.external.database.redis_adapter import RedisAdapter
        # 确保全局REDIS_AVAILABLE为True
        from new.external.database import redis_adapter as redis_adapter_module
